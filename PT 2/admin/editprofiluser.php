...
<?php
	...
	$sql=mysql_query("select foto, nis, nama, id_user, 
					...
					where id_user='$username' and user.user_level = level_user.no and user.user_level!=1");
...
<body>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li>
                        <a href="tambahkelas.php"><i class="glyphicon glyphicon glyphicon-education"></i>&nbsp;&nbsp;Lihat Kelas</a>
                    </li>
					<li>
				...
				<div class="col-md-8 col-sm-6 col-xs-12 personal-info">
				  ...
				  <form class="form-horizontal" role="form" id="form" name="form">
					<div class="form-group">
					  ...
					  <div class="col-lg-8">
						<input class="form-control" value="<?php echo $nomorinduk;?>" type="text" id="nis" name="nis" required>
						<span class="help-block" id="status">Nomor Induk minimal 8 digit angka</span>
					  </div>
					</div>
					<div class="form-group">
					  <label class="col-lg-3 control-label">Nama</label>
					  <div class="col-lg-8">
						<input class="form-control" value="<?php echo $namanya;?>" type="text" id="nama" name="nama" required>
					  </div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
					  ...
					  <div class="col-md-8">
						<input class="form-control" value="janeuser" type="password" id="password" name="password" readonly>
					  </div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
					  ...
					  <div class="col-md-8">
						<textarea rows="3" size="30" id="bio" value="<?php echo $biodata;?>" class="form-control"><?php echo $biodata;?></textarea> 
					  </div>
					</div>
					<div class="form-group">
					  <label class="col-md-3 control-label"></label>
					  <div class="col-md-8">
						<input class="btn btn-primary" value="Save Changes" type="submit" id="save" name="save">
						<span></span>
	...
	$(document).ready(function(){
		...
		$("#form").submit(function() {
			if(!cek || !cekFile){
				...
				$.ajax({
					type: "POST",
					url: "validation/cekupdate.php",
					data:  { username : username, nama : nama, password : password, nis : nis, email : email, tgl : tgl, tipe_user : tipe_user, olduser : olduser, bio: bio },
	...
	$("#nis").keydown(function (e) {
		...
		if ((e.shiftKey || (e.keyCode < 48 || e.keyCode > 57)) && (e.keyCode < 96 || e.keyCode > 105) || $("#nis").val().length>=15) {
			e.preventDefault();
		}
	});
	$("#nis").change(function() {
					...
					var userAsli="<?php echo $username; ?>";
					var nisAsli="<?php echo $nomorinduk; ?>";
					if(userAsli==nisAsli){
