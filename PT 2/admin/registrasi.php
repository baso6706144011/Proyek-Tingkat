                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Tambah User <small>Menu Utama</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="glyphicon glyphicon-home"></i> Tambah User
                            </li>
                        </ol>
                    </div>
                </div>
					...
					<div class="col-xs-10">
						<form class="form-horizontal" id="form" method="POST">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" input id="username" name="username" placeholder="Username" class="form-control" readonly>
							...
							<div class="form-group">
								<label for="nis" class="col-sm-3 control-label">Nomor Induk *</label>
								<div class="col-sm-9">
									<input type="text" id="nis" name="nis" placeholder="Nomor Induk" class="form-control" required>
									...
									<div class="row">
										<div class="col-sm-4">
											<label class="radio-inline">
												<input id="tipe_user" name="tipe_user" type="radio" value="3" required>Siswa
											</label>
										</div>
										<div class="col-sm-4">
											<label class="radio-inline">
												<input id="tipe_user" name="tipe_user" type="radio" value="2" required>Guru
											</label>
										</div>
									</div>
								</div>
    ...
    $(document).ready(function(){
		...
		$("#form").submit(function() {
			if(!cek){
				...
				var tipe_user = $('input[name="tipe_user"]:checked', '#form').val();
				var tgl = $("#tgl").val();
				var email = $("#email").val();
				var nama = $("#nama").val();
				var nis = $("#nis").val();
				$.ajax({
					type: "POST",
					url: "validation/cekregistrasi.php",
					data:  { username : username, nama : nama, password : password, nis : nis, email : email, tgl : tgl, tipe_user : tipe_user },
