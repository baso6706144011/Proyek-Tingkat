 ...
 *   https://datatables.net/download/#bs/dt-1.10.11,b-1.1.2,b-colvis-1.1.2,r-2.0.2
 *
 * Included libraries:
 *   DataTables 1.10.11, Buttons 1.1.2, Column visibility 1.1.2, Responsive 2.0.2
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs/dt-1.10.11,b-1.1.2,b-colvis-1.1.2,r-2.0.2",
